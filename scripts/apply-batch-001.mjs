...
const municipalities = [
  ...
  ['GM0059','Achtkarspelen','Fryslân','Stationsstraat 18','9285NH','Buitenpost'],
...
const findings = [
 ...
 finding('aalsmeer-vacancy-2019','GM0358',['vacancy-obligation'],'Leegstandverordening Aalsmeer 2019',sources.aalsmeerVac,{method:'whole-municipality',conditions:['Zelfstandige woonruimte en kantoren groter dan 500 m²; melding na zes maanden.']},'A',{legalBasis:['Leegstandwet'],effectiveFrom:'2019-07-01'}),
 finding('aalten-good-landlord-2024','GM0197',['good-landlord-permit'],'Verhuurverordening verblijfsruimte Aalten 2024',sources.aalten,{method:'whole-municipality',conditions:['Alle verblijfsruimte; woningcorporaties uitgezonderd.']},'B',{legalBasis:['Wet goed verhuurderschap'],effectiveFrom:'2024-06-18',requiredDocuments:['Modelhuurovereenkomst — Zelf aanleveren','Beschrijving naleving goed verhuurderschap — Zelf aanleveren','Opgave handhavingsbesluiten — Zelf aanleveren']}),
 ...
 finding('alblasserdam-hvv-2025','GM0482',['housing-permit'],'Huisvestingsverordening Gemeente Alblasserdam 2025',sources.alblasserdam,{method:'municipality-and-property-conditions',conditions:['Exact toepassingsbereik moet inhoudelijk worden gecontroleerd vóór publicatie.']},'C',{legalBasis:['Huisvestingswet 2014'],effectiveFrom:'2025-07-10'}),
 ...
 finding('almere-hvv-2024','GM0034',['housing-permit','purchase-protection'],'Huisvestingsverordening Almere 2024',sources.almere,{method:'whole-municipality-and-value',conditions:['Opkoopbescherming gemeentebreed, WOZ lager dan actuele NHG-grens en aanvullende eigendoms-/gebruikseisen.']},'B',{legalBasis:['Huisvestingswet 2014'],requiredDocuments:['Eigendomsbewijs — Zelf aanleveren','Bewijs uitzonderingsgrond — Zelf aanleveren']})
];
const unresolved = {
 'GM1680':['Geen actuele officiële implementatiebron gevonden; bron-/registercontrole door tweede onderzoeker vereist voordat een negatieve conclusie mogelijk is.'],
 ...
 'GM0141':['Bevestig de geïndexeerde WOZ-grens voor 2026 en digitaliseer/vergelijk bijlage 1 van de leegstandverordening.'],
 'GM0484':['Geen actuele officiële implementatiebron gevonden; controleer regionale en gemeentelijke registers handmatig voordat een negatieve conclusie mogelijk is.']
};
...
for(const [code] of municipalities){const r=rs.records.find(x=>x.municipalityCode===code); if(!r||r.researchStatus!=='not-started') throw new Error(`Selection invariant failed ${code}`); const local=findings.filter(f=>f.municipalityCode===code); Object.assign(r,{researchStatus:unresolved[code]?'source-review':'partially-verified',researchStartedAt:date,researchCompletedAt:date,lastCheckedAt:date,nextReviewAt:'2027-02-09',researchedPermitTypes:taxonomy,unresolvedQuestions:unresolved[code]||[],conflicts:[],sourceCount:new Set(local.map(f=>f.officialRegulationUrl)).size,notes:'Batch 001: officiële bronnen onderzocht; geen publieke beslisregel toegevoegd zonder volledige toepassings- en routeverificatie.'});}
write('data/research-status.json',rs);

const rq=read('data/review-queue.json');
const reviewItems=[
 ['batch001-aa-en-hunze-source','GM1680',null,'source-completeness','Officiële zoekronde leverde geen actuele implementatieregeling op. Controleer het gemeentelijke regelingenregister en officiële bekendmakingen opnieuw; vraag: is er op 9 augustus 2026 een actuele regeling binnen de taxonomie?','high'],
 ...
 ['batch001-almelo-index-map','GM0141','almelo-purchase-protection-2024','legal-and-gis','Artikel 3 indexeert de €265.000-grens jaarlijks en de leegstandbijlage gebruikt een aangewezen gebied. Bevestig het bedrag voor 2026 en controleer de officiële bijlage zonder ruimtelijke benadering.','high'],
 ['batch001-alphen-source','GM0484',null,'source-completeness','Alleen vervallen of niet-passende officiële resultaten gevonden. Controleer gemeentelijke en regionale registers; vraag: geldt op 9 augustus 2026 een actuele implementatieregeling binnen de taxonomie?','high']
