...
export function configForMunicipality(nameOrCode){const c=GOLDEN15.find(x=>x.name===nameOrCode||x.municipalityCode===nameOrCode);if(!c)return null;return{sourceId:c.sourceId,municipalityCode:c.municipalityCode,officialUrl:c.officialUrl,objectTypeMap:c.objectTypes,areaTypeMap:c.areaTypes,statusFields:['status','Status','fase','Fase','aanwijzingsstatus','Aanwijzingsstatus']}}
