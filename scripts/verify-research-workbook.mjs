...
if(counts.Regelingen!==rules.length+batch1.findings.length+batch2.findings.length)throw new Error('Regelingen mismatch');
...
if(batch1.municipalities.length!==10||batch2.municipalities.length!==10)throw new Error('Batch size changed');
if(counts.Batches!==2)throw new Error('Batch 002 must appear exactly once');
